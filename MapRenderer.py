...
# poi.sports_complex selects sports complexes.0x795523
import urllib
...
def map_render(location, orientation):
    ...
    URL = "https://maps.googleapis.com/maps/api/staticmap?center=%f,%f&zoom=15&size=640x640&style=feature:all|element:labels|visibility:off&style=feature:poi.business|color:0x186842&style=feature:poi.attraction|color:0xff0000&style=feature:poi.government|color:0x00ff00&style=feature:poi.medical|color:0x0000ff&style=feature:poi.park|color:0x000000&style=feature:poi.place_of_worship|color:0x631355&style=feature:poi.school|color:0x584788&style=feature:poi.sports_complex|color:0x795523&key=%s" % (lat, lon, key)
